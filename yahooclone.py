...
os.system("clear")
print ("\033[39m[\033[31m+\033[39m] Welcome To Yahoo Clone V.1 ")
print ("\033[39m[\033[31m+\033[39m] Author : @N4B1L_09")
print ("\033[39m[\033[31m+\033[39m] Youtube : Nabil Gaming")
